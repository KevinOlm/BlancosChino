...
(function () {
  window.addEventListener('load', function () {
    /** Users */
    //Make admin alert
    Livewire.on('makeAdmin', function (id) {
      Swal.fire({
        title: 'Estás seguro de que quieres hacer administrador a este ususario?',
        text: "Ten cuidado a quién confiarle la administración de tu página, " + "esta persona será capaz de modificar la página de la misma forma que tú. " + "Podrás revertir esta acción en cualquier momento mientras seas administrador",
        icon: 'warning',
    ...
    Livewire.on('blockComments', function (id) {
      Swal.fire({
        title: 'Estás seguro de que quieres prohibir la redacción de comentarios a este ususario?',
        text: 'Si este usuario era administrador de la página con anterioridad, ' + 'esta capacidad le será removida',
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#17a2b8',
        cancelButtonColor: '#6c757d',
    ...
    Livewire.on('deleteUser', function (id) {
      Swal.fire({
        ...
        text: "Esta acción solo debe hacerse como último recurso, en caso de que un cliente " + "acceda a su derecho de cancelación de sus datos. Bajo ninguna circunstancia " + "elimine a un usuario que no se lo ha pedido. Esta acción es permanente y no se " + "puede revertir.",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#17a2b8',
        cancelButtonColor: '#6c757d',
    ...
    Livewire.on('deleteProduct', function (id) {
      Swal.fire({
        title: '¿Estás seguro de que quieres eliminar este producto?',
        text: "Esta acción es irreversible. Los productos desaparecerán de los carritos de los usuarios, " + "sin embargo, el producto quedará registrado en las compras realizadas, y aún tendrás que entregarlo.",
        showCancelButton: true,
        confirmButtonColor: '#17a2b8',
        cancelButtonColor: '#6c757d',
    ...
    Livewire.on('editComment', function (id, comment) {
      Swal.fire({
    ...
    Livewire.on('eliminateComment', function (id) {
      Swal.fire({
    ...
    Livewire.on('updateState', function (id, message) {
      Swal.fire({
    ...
    Livewire.on('showAddress', function (address, phones) {
      var phoneNumbers = '';
      ...
      Swal.fire({
        ...
        html: '<p><b>Estado: </b>' + address.state + '</p>' + '<p><b>Ciudad: </b>' + address.city + '</p>' + '<p><b>Calle y número: </b>' + address.street + '</p>' + '<p><b>Código Postal: </b>' + address.postal_code + '</p>' + phoneNumbers,
        confirmButtonColor: '#17a2b8',
    ...
    Livewire.on('createCategory', function () {
      Swal.fire({
        title: 'Creación de una nueva categoría',
        text: 'La longitud de la categoría debe estar entre 1 y 50 caracteres, de lo ' + 'contrario, los cambios serán ignorados',
        input: 'text',
        showCancelButton: true,
        confirmButtonColor: '#17a2b8',
        cancelButtonColor: '#6c757d',
    ...
    Livewire.on('updateCategory', function (id, category) {
      Swal.fire({
    ...
    Livewire.on('createSize', function () {
      Swal.fire({
        title: 'Creación de un nuevo tamaño',
        text: 'La longitud del tamaño debe estar entre 1 y 50 caracteres, de lo ' + 'contrario, los cambios serán ignorados',
        input: 'text',
        showCancelButton: true,
        confirmButtonColor: '#17a2b8',
        cancelButtonColor: '#6c757d',
    ...
    Livewire.on('updateSize', function (id, size) {
      Swal.fire({
