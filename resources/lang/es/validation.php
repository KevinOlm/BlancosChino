...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'message' => 'mensaje',
        'subject' => 'asunto',
        'productGeneral.groupName' => 'nombre del modelo',
        'productGeneral.category_id' => 'categoría',
        'newImage.validatedImage' => 'imágen',
        'newImage.image' => 'imágen',
        'description' => 'descripción',
        'oldPrice' => 'precio regular',
        'price' => 'precio',
        'newProduct.groupName' => 'nombre del modelo',
        'newProduct.category' => 'categoría',
        'newProductVariations.*.name' => 'nombre de las variaciones',
        'newProductVariations.*.description' => 'descripción de las variaciones',
        'newProductVariations.*.size' => 'tamaño de las variaciones',
        'newProductVariations.*.price' => 'precio de las variaciones',
        'newProductVariations.*.stock' => 'stock de las variaciones',
        'address.state' => 'estado',
        'address.city' => 'ciudad',
        'address.street' => 'calle',
        'address.postal_code' => 'código postal',
        'addToExistingProduct.id' => 'modelo',
        'selectedAddress.state' => 'estado',
        'selectedAddress.city' => 'ciudad',
        'selectedAddress.street' => 'calle y número',
        'selectedAddress.postal_code' => 'código postal',
        'addToExistingProduct.id' => 'modelo',
        'states.*' => 'estados de México',
        'selectedPhone.phone_number' => 'teléfono',
    ],
