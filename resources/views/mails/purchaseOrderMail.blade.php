...
<body>
    <div class="wrapper">
        ...
        <main>
            <div class="container">
                <h2 class="centered">¡Gracias por su compra!</h2>
                <p>Usted ha hecho una compra reciente en blancoschino.com</p>
            ...
            <div class="container">
                <p>
                    Podrás ver más detalles de tu transacción en el apartado
                    <a href="{{route('purchases')}}">"Compras"</a>
                    en tu perfil
                </p>
                <p>
                    Si crees que ha habido algún error, no dudes en enviarnos un comentario por cualquiera de nuestros
                    medios listados en la página de
